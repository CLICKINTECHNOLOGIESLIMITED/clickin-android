...
public class FetchContactFromPhone {
    ...
    public void readContacts() {
        ...
        if (cur != null) {
                ...
                while (cur.moveToNext()) {
                    ...
                    if (Integer.parseInt(cur.getString(cur.getColumnIndex(ContactsContract.Contacts.HAS_PHONE_NUMBER))) > 0) {
                        ...
                        while (pCur.moveToNext()) {
                            ...
                            try {
                                Log.e("initial contactNumber---->", "initial contactNumber------>" + mPhone);
                                if (phone.contains("-")) {
                                ...
                                Log.e("contactNumber", "contactNumber " + mPhone + " , ");
            ...
            com.sourcefuse.clickinandroid.utils.Log.e("contact in Featch contact--->", "" + Utils.itData);
        ...
        if (Utils.itData.size() > 0) {
            try {
                ...
                while (myiterator.hasNext()) {
                    ...
                    com.sourcefuse.clickinandroid.utils.Log.e("key 1----->", "key 1--->" + key1);
                    if (!(key1.contains("+"))) {
                        if (!Utils.isEmptyString(countryCode))
                    ...
                    com.sourcefuse.clickinandroid.utils.Log.e("key 2----->", "key 2--->" + key1);
                    list.add(key1);
                                ...
                                if (clickers == existcode) {
                                    ...
                                    if (cb != null) {
                                        ...
                                        if (data.has("phone_no")) {
                                            ...
                                            com.sourcefuse.clickinandroid.utils.Log.e("on sucess----->", "" + data.getString("phone_no"));
                                        }

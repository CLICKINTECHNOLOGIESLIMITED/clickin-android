...
public class Constants {
    ...
    public static final String SEND_REQUEST_WITH_SMS_MESSAGE= "Hey ! Lets you and I get Clickin' ! Download now - (link)";
    public static final String SEND_REQUEST_WITH_SMS_MESSAGE_SPREAD= "Hey! Come join us on Clickin' - Dowload Now - (link)";

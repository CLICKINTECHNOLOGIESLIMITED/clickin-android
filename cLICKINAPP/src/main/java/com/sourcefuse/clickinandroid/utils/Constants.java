...
public class Constants {
   ...
   public static final String CLICKIN_APP_ID = "5";
    ...
    public static final String MIX_PANEL_TOKEN = "157eabd1c58d5e7ed4fadf1c3328eec4"; //prod
 //   public static final String MIX_PANEL_TOKEN = "34b90dcc1a3f069eec5baa3208229d4b"; //dev
    ...
    public static final int RELATIONSHIP_DELETE=7; //this is only for gcm internal assessment

...
/**
 * Created by chandra on 14/7/14.
 */
public class PinnedSecListViewForFeed extends AutoScrollListView {
    ...
    public PinnedSecListViewForFeed(Context context, AttributeSet attrs, int defStyle) {
    ...
    void createPinnedShadow(int position) {
        ...
        View pinnedView = getAdapter().getView(position, pinnedShadow.view, PinnedSecListViewForFeed.this);
        pinnedView.setBackgroundColor(getResources().getColor(R.color.white_with_transparent));

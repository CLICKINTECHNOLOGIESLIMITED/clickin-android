 ...
 * still scrolled.
 */
public class PinnedSectionListViewNew extends AutoScrollListView {
    ...
    public PinnedSectionListViewNew(Context context, AttributeSet attrs) {
        super(context, attrs);
        initView();
    }

    public PinnedSectionListViewNew(Context context, AttributeSet attrs, int defStyle) {
    ...
    void createPinnedShadow(int position) {
        ...
        pinnedView.setBackgroundResource(R.drawable.gradient_);
